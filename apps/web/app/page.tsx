    ...
    <>
      <section className="content" id="today">
        <div className="hero-line">
          ...
          <div className="reset"><span>Question ends in</span><strong suppressHydrationWarning>{formatDuration(remaining)}</strong></div>
        </div>
        <div className="grid">
          <div className="left">
