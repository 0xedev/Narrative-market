export const narrativeThroneAbi = [
  ...
  { type: "function", name: "startFirstQuestion", stateMutability: "nonpayable", inputs: [{ name: "questionId", type: "bytes32" }, { name: "curator", type: "address" }, { name: "questionUri", type: "string" }, { name: "duration", type: "uint256" }, { name: "floor", type: "uint256" }], outputs: [] },
  { type: "function", name: "rotateIfDue", stateMutability: "nonpayable", inputs: [{ name: "duration", type: "uint256" }, { name: "floor", type: "uint256" }], outputs: [] },
